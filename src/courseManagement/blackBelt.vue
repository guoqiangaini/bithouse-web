    ...
    <el-tab-pane label="题库统计" name="first">
      ...
      <div class="wai">
        ...
        <ul >
          ...
          <el-button size="mini" style="margin-right: 15px" type="info" @click="dialogVisible = true">新增题库</el-button>
          ...
          >
            <!-- 是否支持发送cookie信息 -->
            <el-button   size="mini" type="info" @click="importData">导入</el-button>
      ...
      >
        <el-form ref="form" :show-message="false"  :model="form" :rules="rules"  label-width="80px">
          ...
          <el-form-item label="等级选择" prop="region">
            <el-select v-model="form.region" clearable placeholder="全部" size="mini" style="width: 220px">
              <el-option
                v-for="item in levels"
                :key="item.id"
                :label="item.name"
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="正确答案" prop="rightAnswers">
                <el-select size="mini" v-model="form.rightAnswers" style="width: 220px" clearable placeholder="请选择">
                  <el-option
      ...
      >
        <el-form ref="form" :model="form" label-width="80px">
          <el-form-item label="等级选择">
            <el-select v-model="form.region" clearable placeholder="全部" size="mini" style="width:90px">
              <el-option
                v-for="item in levels"
                :key="item.id"
                :label="item.name"
          ...
          <el-form-item label="正确答案">
            <el-input v-model="form.rightAnswers" style="width: 60%"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button @click="updateDialogVisible = false">取消</el-button>
            <el-button type="primary" @click="onSubmitUpdate" class="btn">提交</el-button>
          </el-form-item>
        </el-form>
    ...
    data() {
      return {
        ...
        rules:{
          ...
          choiceC: [
            {required: true, message: '选项C', trigger: 'blur' }
          ],
          choiceD: [
            { required: true, message: '选项D', trigger: 'blur' }
          ],
          rightAnswers: [
      ...
      dataParmes(form){
        this.$refs.form.validate((valid) => {
          if (valid) {
            ...
            this.$axios.postRequest(questionParams).then(function(res) {
...
//guanbi
      ...
      selectTestBank(column){
        ...
        this.$axios.postRequest(bankParams).then(function(res) {
          //成功之后处理逻辑
      ...
      updateTestBank(){
        if(this.multipleSelection.length<1){
          ...
          var arr1=[];
          this.multipleSelection.forEach(function(v){ arr1.push(v.id,v.jlevel,v.jquestionName,v.optionA,v.optionB,v.optionC,v.optionD,v.correct_answer);});
          this.form.number=arr1[0]
          this.form.region=arr1[1]
          this.form.name=arr1[2]
          this.form.choiceA=arr1[3]
          this.form.choiceB=arr1[4]
          this.form.choiceC=arr1[5]
          this.form.choiceD=arr1[6]
          this.form.rightAnswers=arr1[7]
